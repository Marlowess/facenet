# Pyramid-Net implementation for ResNet
...
class PyramidNet:
    def __init__(self, images,  input_shape=(160, 160, 3), num_classes=512, weight_decay=2e-4, data_format='channels_last'):

        config = {
            'is_bottleneck': True,
            'residual_block_list': [3, 4, 23, 3],  # ResNet-101
